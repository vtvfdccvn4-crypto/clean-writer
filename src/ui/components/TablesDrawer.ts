...
const renderTableStyle = (prefix: string, title: string, secondary = false) => `
  <details class="drawer-details drawer-card" open>
    ...
    <div class="drawer-details-body">
      ...
      <div class="drawer-grid drawer-grid-2">
        ${renderDrawerControl('Header text', renderDrawerColorControl(`${prefix}-header-text-color`, 'Header text colour', '#FFFFFF'))}
        ${renderDrawerControl('Header background', renderDrawerColorControl(`${prefix}-header-background`, 'Header background colour', secondary ? '#E8ECE8' : '#405A78'))}
        ${renderDrawerControl('Body text', renderDrawerColorControl(`${prefix}-body-text-color`, 'Body text colour', '#000000'))}
        ${renderDrawerControl('Body background', renderDrawerColorControl(`${prefix}-body-background`, 'Body background colour', '#FFFFFF'))}
        ${renderDrawerControl('Alternate row', renderDrawerColorControl(`${prefix}-alternate-row-color`, 'Alternate row colour', '#F2F2F2'))}
        ${renderDrawerControl('Border colour', renderDrawerColorControl(`${prefix}-border-color`, 'Border colour', '#808080'))}
