          ...
          <div class="drawer-grid drawer-grid-2">
            ...
            ${renderDrawerControl(
              ...
              `<span class="block-glyph-picker-control">
                ...
                <div class="block-glyph-picker-row">
                  <button id="cbs-icon-trigger" class="block-glyph-trigger" type="button" aria-haspopup="listbox" aria-expanded="false" title="Choose block glyph">
                  ...
                  <button id="btn-upload-glyph" class="icon-btn block-glyph-upload-button" type="button" title="Upload new glyph" aria-label="Upload new glyph">+</button>
                </div>
